...
def _verify_wheel(path: Path) -> dict[str, object]:
    with zipfile.ZipFile(path) as archive:
        ...
        _require(
            dist_info == ["meridian_plugin_observability-1.0.3.dist-info"],
        ...
        required = {
            ...
            "meridian_storage/plugins/observability/compatibility.json",
            "meridian_storage/plugins/observability/py.typed",
        }
        ...
        _require(runtime_requirements == EXPECTED_REQUIREMENTS, "wheel runtime requirements differ")
...
def _verify_sdist(path: Path) -> dict[str, object]:
    with tarfile.open(path, "r:gz") as archive:
        ...
        _require(
            prefixes == {"meridian_plugin_observability-1.0.3"},
        ...
        required = {
            ...
            f"{prefix}/src/meridian_storage/plugins/observability/compatibility.json",
        }
