...
4. released Evidence bridge, parameterized query compilation, and required real
   ClickHouse 25.3/25.8 log/span/metric round trips, cursor paging and tenant isolation;
