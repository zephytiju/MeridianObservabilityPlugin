...
Version 1.0.0 supports Python 3.12 through 3.14 and pins the released Core,
...
Locked design baseline: HLD 56, Catalogs and Public Interfaces 70, Engine
Adapters 24, Kafka Adapter 6, MeridianConstructs 45, and Observability LLD 17.
